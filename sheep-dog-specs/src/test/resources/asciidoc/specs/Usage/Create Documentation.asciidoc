...
* When: The xtext plugin validate action for a test step container section is performed as follows
+
|===
| Selected Step
| 1            
...
* When: The xtext plugin validate action for a test step section is performed
