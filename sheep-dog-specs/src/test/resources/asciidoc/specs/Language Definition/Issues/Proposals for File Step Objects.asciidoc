...
* And: The ProcessIssues.asciidoc file TestProject/TestDocumentList/1/TestStepContainerList/1/TestStepList node is created as follows
+
|===
| Test Step Full Name                      
| The daily batchjob Output file is present
...
* And: The ProcessIssues.asciidoc file TestProject/TestDocumentList/1/TestStepContainerList/2/TestStepList node is created as follows
+
|===
| Test Step Full Name
| empty              
