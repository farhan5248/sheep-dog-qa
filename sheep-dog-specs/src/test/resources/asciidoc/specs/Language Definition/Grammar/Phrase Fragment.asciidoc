...
=== Then: The ProcessGrammarFragment.asciidoc file Phrase tag fragment will be decomposed as follows
|===
| Tag List  
| {Tag List}
|===
...
=== Then: The ProcessGrammarFragment.asciidoc file Phrase todo fragment will be decomposed as follows
|===
