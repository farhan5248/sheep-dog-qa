...
* Then: The spec-prj project ProcessGrammarType.asciidoc file TestSuite type assignments will be as follows
+
|===
...
* Then: The spec-prj project ProcessGrammarType.asciidoc file TestSuite type derived attributes will be as follows
+
|===
| Name
| {Name}
