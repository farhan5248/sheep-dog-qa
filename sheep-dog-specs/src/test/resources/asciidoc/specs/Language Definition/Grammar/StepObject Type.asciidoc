...
* Then: The spec-prj project src/test/resources/asciidoc/stepdefs/daily batchjob/Input file.asciidoc file Model/StepObjectList/2 node is created as follows
+
|===
| Step Object Full Name
| Second Step Object   
...
* And: The Input file.asciidoc file Model/StepObjectList/1/StepDefinitionList node will be empty
