...
* Then: The spec-prj project ProcessGrammar.asciidoc file phrase tag fragment will be decomposed as follows
+
|===
| Tag List  
| {Tag List}
...
* Then: The spec-prj project ProcessGrammar.asciidoc file phrase todo fragment will be decomposed as follows
+
|===
