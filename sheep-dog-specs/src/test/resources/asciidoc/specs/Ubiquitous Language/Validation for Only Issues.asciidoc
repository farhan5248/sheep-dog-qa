...
* When: The xtext plugin validate cell action is performed
...
* When: The xtext plugin validate test suite action is performed
...
* When: The xtext plugin validate test step container action is performed
