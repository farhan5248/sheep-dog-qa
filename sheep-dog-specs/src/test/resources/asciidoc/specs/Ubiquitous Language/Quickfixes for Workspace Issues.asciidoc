...
* And: The xtext plugin validate action for a row section is performed
...
* When: The xtext plugin list quickfixes action for a row section is performed
...
* And: The xtext plugin validate action for a text section is performed
...
* When: The xtext plugin list quickfixes action for a text section is performed
