cd ..
call mvn clean
call mvn org.farhan:sheep-dog-dev-svc-maven-plugin:asciidoctor-to-uml -Dtags="api" -Dhost="dev.sheepdogdev.io"
call mvn org.farhan:sheep-dog-dev-svc-maven-plugin:asciidoctor-to-uml -Dtags="gen" -Dhost="dev.sheepdogdev.io"
