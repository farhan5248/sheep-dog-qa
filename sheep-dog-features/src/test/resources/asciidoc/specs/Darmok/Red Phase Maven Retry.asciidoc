= Test-Suite: Red Phase Maven Retry
...
== Test-Setup: A failing scenario that enters the red phase
...
== Test-Case: Asciidoctor-to-uml retries on Service-not-available then succeeds
...
== Test-Case: Asciidoctor-to-uml exhausts retries on Service-not-available
...
== Test-Case: Uml-to-cucumber-guice retries on Service-not-available then succeeds
...
== Test-Case: Uml-to-cucumber-guice exhausts retries on Service-not-available
