= Test-Suite: Green Prompt Template
...
== Test-Setup: A failing scenario that reaches green phase
...
== Test-Case: Green phase invokes claude with rendered template path
