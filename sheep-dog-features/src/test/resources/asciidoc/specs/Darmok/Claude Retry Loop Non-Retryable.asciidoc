= Test-Suite: Claude Retry Loop Non-Retryable
...
== Test-Case: Claude exits 1 with an opaque failure
...
== Test-Case: Claude exits 137 (SIGKILL)
...
== Test-Case: Claude exits 130 (SIGINT)
...
== Test-Case: Mojo log surfaces error reason on non-retryable failure
