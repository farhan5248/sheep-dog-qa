= Test-Suite: Red Phase Maven Failures
...
== Test-Case: The asciidoctor-to-uml command fails non-retryably
...
== Test-Case: The uml-to-cucumber-guice command fails non-retryably
...
== Test-Case: The generated runner class fails to compile
