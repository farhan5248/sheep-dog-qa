= Test-Suite: Scenario Loop Multiple Scenarios
...
== Test-Case: Two scenarios processed in one run, in file order
...
== Test-Case: Each scenario gets its own session ID
...
== Test-Case: Two scenarios from separate File blocks
