= Test-Suite: Commit Behavior Clean Workspace
...
== Test-Setup: An already-passing scenario backed by a clean workspace
...
== Test-Case: Red commit is skipped when nothing is staged
