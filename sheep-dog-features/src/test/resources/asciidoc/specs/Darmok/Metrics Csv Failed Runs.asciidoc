= Test-Suite: Metrics Csv Failed Runs
...
== Test-Setup: A failing scenario whose red phase passes
...
== Test-Case: Green failure still records a metrics row with red SHA
...
== Test-Case: Refactor failure still records a metrics row with red SHA
