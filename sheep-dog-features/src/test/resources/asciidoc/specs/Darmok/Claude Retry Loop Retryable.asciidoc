= Test-Suite: Claude Retry Loop Retryable
...
== Test-Setup: A failing scenario that enters the green phase
...
== Test-Case: Claude retries on API Error 500 then succeeds
...
== Test-Case: Claude retries on API Error 529 then succeeds
...
== Test-Case: Claude retries on Internal server error then succeeds
...
== Test-Case: Claude retries on overloaded then succeeds
...
== Test-Case: Claude exhausts retries on API Error 500
...
== Test-Case: Claude exhausts retries on API Error 529
...
== Test-Case: Claude exhausts retries on Internal server error
...
== Test-Case: Claude exhausts retries on overloaded
...
== Test-Case: The refactor phase also retries on retryable errors
