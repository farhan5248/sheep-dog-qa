...
== Test-Setup: A failing scenario that reaches the verify sub-step
...
== Test-Case: Green verify passes on the first attempt
...
== Test-Case: Refactor verify passes on the first attempt
...
== Test-Case: Green verify fails once then succeeds after resume
...
== Test-Case: Green verify fails for every attempt
...
== Test-Case: Refactor verify fails once then succeeds after resume
...
== Test-Case: Refactor verify fails for every attempt
...
== Test-Case: Green verify retry brackets the resume call with Running and Completed lines
...
== Test-Case: Refactor verify retry brackets the resume call with Running and Completed lines
