= Test-Suite: Refactor Session Mode
...
== Test-Case: Continue mode runs compact then starts refactor on green session
...
== Test-Case: Continue mode refactor verify-fail resume stays on green session
