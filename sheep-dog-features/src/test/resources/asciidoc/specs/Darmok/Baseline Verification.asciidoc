...
== Test-Case: Baseline build passes and scenario loop proceeds
...
== Test-Case: Baseline build failure aborts the run
...
== Test-Case: Baseline emits Running and Completed bracket lines
...
== Test-Case: Baseline emits bracket lines before the failure abort line
