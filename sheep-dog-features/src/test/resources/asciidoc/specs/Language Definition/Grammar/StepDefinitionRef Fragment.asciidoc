...
- command - Subprocess commands invoked by goals (e.g. git, claude, maven)
- stage - Pipeline stages
- phase - RGR workflow phases (red, green, refactor)
...
=== Then: The ProcessGrammarFragment.asciidoc file StepDefinitionRef part fragment will be decomposed as follows
|===
...
| git command is executed             | git command               | git              | command    | Subprocess commands invoked by goals (e.g. git, claude, maven)
| deploy stage is executed            | deploy stage              | deploy           | stage      | Pipeline stages
| red phase is executed               | red phase                 | red              | phase      | RGR workflow phases (red, green, refactor)
|===
...
=== Then: The ProcessGrammarFragment.asciidoc file StepDefinitionRef state fragment will be decomposed as follows
|===
